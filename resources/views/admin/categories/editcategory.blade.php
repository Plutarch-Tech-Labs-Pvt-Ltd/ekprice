...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content" class="content">
            ...
            <h1>Edit Category</h1>
    <hr>
    <form action="{{action('Admin\CategoriesController@update', $categories->cat_id)}}" method="POST">
     <input type="hidden" name="_method" value="PUT">
     {{ csrf_field() }}
      <div class="form-group">
    
        <label for="title">category Title</label>
        <input type="text" value="{{$categories->cat_title}}" class="form-control" id="taskTitle"  name="title" >
      </div>     
      @if ($errors->any())
      ...
      @endif
      <button type="button" class="btn btn-primary"><a href="{{ route('admin.categories') }}">Back</a></button>
