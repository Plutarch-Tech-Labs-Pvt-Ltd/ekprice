    ...
    <div class="wrapper">
        ...
        <div id="content" class="content">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="card text-white bg-card mt-5">                       
                                    <div class="card-body">                                       
                                        <h5 class="card-title mt-1 ml-2">900 <i class="fa fa-user float-right display-4 mr-4"></i></h5>                                        
                                        <h5 class="card-title mt-4 ml-2">Customers<h5>                                                                            
                                    </div> 
                            </div> 
                    </div>
                    <div class="col-sm-4">
                    <div class="card text-white bg-card mt-5">                   
                                    <div class="card-body">                                       
                                        <h5 class="card-title mt-1 ml-2">900 <i class="fa fa-user float-right display-4 mr-4"></i></h5>                                        
                                        <h5 class="card-title mt-4 ml-2">Sellers<h5>                                                                            
                                    </div>
                            </div>   
                    </div>
                    <div class="col-sm-4">
                    <div class="card text-white bg-card mt-5">                  
                    <div class="card-body">                                       
                                        <h5 class="card-title mt-1 ml-2">900 <i class="fa fa-th-list float-right display-4 mr-4"></i></h5>                                        
                                        <h5 class="card-title mt-4 ml-2">Orders placed<h5>                                                                            
                                    </div>
                            </div> 
                    </div>
                    <div class="col-sm-4">
                    ...
                    <div class="card-body">                                       
                                        <h5 class="card-title mt-1 ml-2">1800 <i class="fas fa-hand-holding-usd float-right display-4 mr-4"></i></h5>                                        
                                        <h5 class="card-title mt-4 ml-2">Transacted Money<h5>                                                                            
                                    </div>
                            </div> 
                    </div>
                    <div class="col-sm-4">
                    <div class="card text-white bg-card mt-5">
                         <div class="card-body">                                       
                                        <h5 class="card-title mt-1 ml-2">900 <i class="fa fa-th-list float-right display-4 mr-4"></i></h5>                                        
                                        <h5 class="card-title mt-4 ml-2">Services listed<h5>                                                                            
                                    </div>
                            </div> 
                    </div>
                </div>
