    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1" uk-slider="autoplay:true; autoplay-interval:2500;">
...
<div class="homeSection4">
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-xl-6 col-md-6" uk-scrollspy="target: div; cls: uk-animation-fade; delay: 200">
                <div class="pr-5">
            ...
            <div class="col-xl-6 col-md-6" uk-scrollspy="target: h2, li; cls: uk-animation-scale-up; delay: 500">
            ...
            <div class="col-xl-12">
                ...
                <div uk-slider="autoplay:true; autoplay-interval: 3000">
                    <div class="uk-position-relative">
                        <div class="uk-slider-container" uk-scrollspy="cls: uk-animation-slide-right-medium; delay: 500">
                            <ul class="uk-slider-items uk-child-width-1-1 uk-child-width-1-3@m uk-grid mt-5">
                                <li>
